...
public class V_MenuDirecteur extends JFrame implements ActionListener {
	//Attributs priv�s
	...
	class ActionReserverObjet implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			V_MenuDirecteur.this.getContentPane().removeAll();
			V_MenuDirecteur.this.getContentPane().add(new V_ReserverMateriel(lesMat));
			V_MenuDirecteur.this.revalidate();
			V_MenuDirecteur.this.setVisible(true);
