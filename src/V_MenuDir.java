...
public class V_MenuDir extends JFrame implements ActionListener {
	//Attributs privés
	...
	public V_MenuDir(int idUser) {
        ...
        this.menuReservation = new JMenu("Statistiques");
        this.reserverObjet = new JMenuItem("Stats par visiteur");
        this.voirReservations = new JMenuItem("Récapitulatif des emprunts");
        this.reserverObjet.addActionListener(new ActionVoirStatVisit());
...
//        this.reserverVoiture.addActionListener(new ActionReserverVoiture());
	...
	class ActionVoirStatVisit implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			ArrayList<StatVisiteur> lesStats = Modele.getStatVisiteur();
			V_MenuDir.this.getContentPane().removeAll();
			V_MenuDir.this.getContentPane().add(new V_voirStatVisit(lesStats));
			V_MenuDir.this.revalidate();
			V_MenuDir.this.setVisible(true);
			
		}
	}
	class ActionDeconnexion implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			V_MenuDir.this.dispose();
